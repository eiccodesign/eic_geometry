...
# Output file names
info_string="pi0_${distribution}_${energy_min}GeV-${energy_max}GeV_theta_${theta_min}deg-${theta_max}deg_${job_id}"
...
root -l -b -q "${DETECTOR_PATH}/hepmc_generation/gen_pi0.cxx(\
${num_events},\
\"${hepmcfile}\",\
${theta_min},\
${theta_max},\
