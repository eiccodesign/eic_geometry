...
energy_max=250
num_events=100
theta_min=0.0 # in mrad
theta_max=3.0 # in mrad
phi_min=0.0 # in degrees
phi_max=360.0 # in degrees 
...
# Output file names
info_string="sigmadecay_${distribution}_${energy_min}GeV-${energy_max}GeV_theta_${theta_min}mrad-${theta_max}mrad_${job_id}"
...
root -l -b -q "${DETECTOR_PATH}/hepmc_generation/gen_sigma_decay.cxx(\
${num_events},\
\"${hepmcfile}\",\
${theta_min},\
${theta_max},\
