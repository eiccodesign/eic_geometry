...
# Output file names
info_string="lambdadecay_${distribution}_${energy_min}GeV-${energy_max}GeV_theta_${theta_min}deg-${theta_max}deg_${job_id}"
...
root -l -b -q "${DETECTOR_PATH}/hepmc_generation/gen_lambda_decay.cxx(\
${num_events},\
\"${hepmcfile}\",\
${theta_min},\
${theta_max},\
